import { getJudgeProjectSubmissionStatusController } from "@/modules/judging/controllers";
...
export const GET = async (
  ...
  return await getJudgeProjectSubmissionStatusController(judging_id, challenge_id);
};
