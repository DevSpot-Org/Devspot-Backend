import { getChallengeProjectsForWinnerAssignmentController } from "@/modules/judging/controllers";
...
export const GET = async (
  ...
  return await getChallengeProjectsForWinnerAssignmentController(judging_id, challenge_id);
};
